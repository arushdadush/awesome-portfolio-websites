...
<a class="navbar-brand" href="index.html">Joey Gerard</a>
  ...
  <footer class="footer sticky-bottom"  style="background-color:#2b2a2a;">
    <div class="p-4">
      <div class="container-fluid quote-container">
        ...
        <p class="tag" >"Discipline to me is sacrifice; it's willingness to give up something you want to do, so you can better yourself." – Bobby Bowden</p>
      </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 col-md-12 mb-4 mb-md-0 justify-content-center">
            ...
            <img src="assets/images/qr-code(6).png" alt="Your Image Description" style="max-width: 100%; height: auto;">
          </div>
          ...
          <div class="col-lg-6 col-md-12 mb-4 mb-md-0 form-comtainer">
            <div class="form-style-6">
               <div class="form-header">
                  ...
                  <form name="form1" action="https://formcarry.com/s/FWdCUvx0qEG" method="POST" accept-charset="UTF-8" >
